...
"use strict";
/*!*********************************************************!*\
  !*** ./Modules/Product/Resources/assets/js/category.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var lodash_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/array */ "./node_modules/lodash/array.js");
/* harmony import */ var lodash_array__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_array__WEBPACK_IMPORTED_MODULE_2__);
...
$(document).ready(function () {
  ...
  $('#category-form').on('submit', function (event) {
    ...
    var selectors = ['name', 'persian_name', 'description', 'parent_id', 'show_in_menu'];
    ...
    showLoading();
    var image = $("#ImageBrowse").attr('data-image');
    // image = image.replace('data:image/', '');
    // image = image.replace('data:image/jpeg;base64,', '');
    // image = image.replace(' ', '+');
    var data = (0,_public_js_modules_validation__WEBPACK_IMPORTED_MODULE_0__.getData)(selectors, {
    ...
    $.ajax({
      ...
      success: function success(_ref2) {
        ...
        if ($('table.table-responsive tbody tr.bg-light').length < 1) {
          ...
          $('a.add-row').attr('href', (0,_public_js_modules_route__WEBPACK_IMPORTED_MODULE_1__.getRouteByName)('categories.create'));
        }
      },
      error: function error(data) {
        // if(data.status === 404){
