...
@section('content')
    ...
    <main class="w-100 h-100 flex-center flex-wrap">
        <section class="form-box col-12 col-md-7 d-flex flex-wrap p-2 bg-white__default">
            ...
            <form action="{{route('roles.permission.add', ['role' => $role->id])}}" method="post" id="permission-form" class="col-12 d-flex flex-wrap align-items-center justify-content-start permission-box">
                @csrf
